...
export const updateActiveLetter = (testInformation: TestInformation, currentInputWord: string, inputWordsArray: string[]): Word[] => {
	const newTestWords = testInformation.words.map((wordObject, wordIndex) => {
