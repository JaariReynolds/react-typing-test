...
export const testWordsGenerator = (testLengthWords: number, numbers: boolean, punctuation: boolean): TestWords => {
	...
	return {words: randomWordArray, errorCountHard: 0, errorCountSoft: 0, timeElapsedMilliSeconds: 0, characterCount: characterCount, keyPressCount: 0, wpmArray: [], currentAverageWPMArray: [], averageWPM: 0, accuracy: 0};
};