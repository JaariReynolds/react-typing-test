...
const ColourPaletteLabel = ({colourPalette, backgroundColour}: ColourPaletteLabelProps) => {
	return (
		<div style={backgroundColour ? {backgroundColor: colourPalette.backgroundColour} : {}} className="selectable-colour-palette-label">
