  ...
  return (
    <div className="footer">
      ...
      >
        <FontAwesomeIcon
          icon={faPalette}
          className="palette-icon standard-icon-left"
        />
        palette
        <ColourPaletteLabel
      ...
      <a
        href="https://github.com/JaariReynolds/react-typing-test"
        target="_blank"
        title="github.com/JaariReynolds/react-typing-test"
