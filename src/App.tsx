		...
		<div className="App">
			<div className="flex items-center justify-center">
				<div className="grid grid-cols-3 gap-1 w-4/5">
					...
					<div className={`col-span-1 text-center pl-4 select-none transition-opacity opacity-${componentOpacity} duration-${COMPONENT_FADE_DURATION}`}>
					...
					<div className="col-span-full select-none bg-zinc-600 rounded h-96">
